...
ax.add_artist(Arrow3D([0.5, 0.5], [0.4, 0.4], [0.1, 0.9], mutation_scale = 25., lw = 1.5, arrowstyle='->', color = 'royalblue', zorder = 3))
ax.add_artist(Arrow3D([0.5, 0.5], [0.5, 0.5], [0.1, 0.9], mutation_scale = 25., lw = 1.5, arrowstyle='->', color = 'royalblue', zorder = 3))
ax.add_artist(Arrow3D([0.5, 0.5], [0.6, 0.6], [0.1, 0.9], mutation_scale = 25., lw = 1.5, arrowstyle='->', color = 'royalblue', zorder = 3))
ax.text(0.5, 0.67, 0.7, r'$\bm J_\mathrm{eff}$', color = 'royalblue', ha = 'center', va = 'center', size = 'x-large')
ax.plot(0.5 + 0.4 * np.cos(2 * np.pi * ts), 0.5 + 0.4 * np.sin(2 * np.pi * ts), 0.5 + 0 * ts, color = 'limegreen', zorder = 3)
ax.add_artist(Arrow3D([0.5 + 0.4 * np.cos(0.04 * np.pi), 0.5 + 0.4 * np.cos(0.07 * np.pi)], [0.5 + 0.4 * np.sin(0.04 * np.pi), 0.5 + 0.4 * np.sin(0.07 * np.pi)], [0.5, 0.5], mutation_scale = 25., lw = 1.5, arrowstyle='->', color = 'limegreen', zorder = 3))
ax.plot(0.5 + 0.2 * np.cos(2 * np.pi * ts), 0.5 + 0.2 * np.sin(2 * np.pi * ts), 0.5 + 0 * ts, color = 'limegreen', zorder = 3)
ax.add_artist(Arrow3D([0.5 + 0.2 * np.cos(0.1 * np.pi), 0.5 + 0.2 * np.cos(0.15 * np.pi)], [0.5 + 0.2 * np.sin(0.1 * np.pi), 0.5 + 0.2 * np.sin(0.15 * np.pi)], [0.5, 0.5], mutation_scale = 25., lw = 1.5, arrowstyle='->', color = 'limegreen', zorder = 3))
ax.text(0.5, 0.7, 0.37, r'$\bm B_\mathrm{DM}$', color = 'limegreen', ha = 'center', va = 'center', size = 'x-large')
